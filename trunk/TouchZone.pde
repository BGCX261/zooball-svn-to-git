public class TouchZone implements Touchable
{
  ...
  public void drawDebug( ) {
    int strokeSize = 4;
    fill( 0xFF, 0xFF, 0x00 );
    rect( (float)position.x, (float)position.y, (float)size.x, strokeSize );
    rect( (float)position.x, (float)position.y, strokeSize, (float)size.y );
    rect( (float)position.x + (float)size.x, (float)position.y + (float)size.y, (float)-size.x, -strokeSize );
    rect( (float)position.x + (float)size.x, (float)position.y + (float)size.y, -strokeSize, (float)-size.y );
  }
}
